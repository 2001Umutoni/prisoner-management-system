 ...
 * @author HP
 */
public class VisitorLoginForm extends javax.swing.JFrame {
   Connection con = null;
         ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pms/image/visit2.jpg"))); // NOI18N
    ...
    private void loginbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbtnActionPerformed
       String name=nametxt.getText();
        ...
        try {
            String sql = "SELECT * FROM visitor WHERE visitorname=? AND password=?";
            ...
            if (rs.next()) {
                ...
                VisitorDashboard dash = new  VisitorDashboard();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisitorLoginForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisitorLoginForm().setVisible(true);
            }
        });
    }
